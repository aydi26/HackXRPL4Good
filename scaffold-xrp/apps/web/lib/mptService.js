/**
 * Service de création de MPToken pour le Frontend
 * 
...
/**
 * Convertit une string en hexadécimal (compatible navigateur)
 * @param {string} str - String à convertir
 * @returns {string} String en hexadécimal
 */
 ...
 * import { createMPT } from "@/lib/mptService";
 * 
 ...
 * }
 */
export async function createMPT(
    walletManager,
    lotNumber,
    nftHash,
    issuerAddress,
    ...
    try {
        ...
        // Convertir en hex (compatible navigateur)
